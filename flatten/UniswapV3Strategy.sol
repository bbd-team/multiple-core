...
// Dependency file: @uniswap/v3-core/contracts/libraries/TickMath.sol
...
// Dependency file: @uniswap/v3-periphery/contracts/libraries/PositionKey.sol
...
// Dependency file: @uniswap/v3-core/contracts/libraries/FullMath.sol
...
// Dependency file: @uniswap/v3-core/contracts/libraries/FixedPoint96.sol
...
// Dependency file: @uniswap/v3-periphery/contracts/libraries/LiquidityAmounts.sol

// pragma solidity >=0.5.0;

// import '/Users/wujiajun/Documents/code/dex/mul.finance/node_modules/@uniswap/v3-core/contracts/libraries/FullMath.sol';
// import '/Users/wujiajun/Documents/code/dex/mul.finance/node_modules/@uniswap/v3-core/contracts/libraries/FixedPoint96.sol';
...
// Dependency file: @uniswap/v3-core/contracts/interfaces/pool/IUniswapV3PoolImmutables.sol
...
// Dependency file: @uniswap/v3-core/contracts/interfaces/pool/IUniswapV3PoolState.sol
...
// Dependency file: @uniswap/v3-core/contracts/interfaces/pool/IUniswapV3PoolDerivedState.sol
...
// Dependency file: @uniswap/v3-core/contracts/interfaces/pool/IUniswapV3PoolActions.sol
...
// Dependency file: @uniswap/v3-core/contracts/interfaces/pool/IUniswapV3PoolOwnerActions.sol
...
// Dependency file: @uniswap/v3-core/contracts/interfaces/pool/IUniswapV3PoolEvents.sol
...
// Dependency file: @uniswap/v3-core/contracts/interfaces/IUniswapV3Pool.sol

// pragma solidity >=0.5.0;

// import '/Users/wujiajun/Documents/code/dex/mul.finance/node_modules/@uniswap/v3-core/contracts/interfaces/pool/IUniswapV3PoolImmutables.sol';
// import '/Users/wujiajun/Documents/code/dex/mul.finance/node_modules/@uniswap/v3-core/contracts/interfaces/pool/IUniswapV3PoolState.sol';
// import '/Users/wujiajun/Documents/code/dex/mul.finance/node_modules/@uniswap/v3-core/contracts/interfaces/pool/IUniswapV3PoolDerivedState.sol';
// import '/Users/wujiajun/Documents/code/dex/mul.finance/node_modules/@uniswap/v3-core/contracts/interfaces/pool/IUniswapV3PoolActions.sol';
// import '/Users/wujiajun/Documents/code/dex/mul.finance/node_modules/@uniswap/v3-core/contracts/interfaces/pool/IUniswapV3PoolOwnerActions.sol';
// import '/Users/wujiajun/Documents/code/dex/mul.finance/node_modules/@uniswap/v3-core/contracts/interfaces/pool/IUniswapV3PoolEvents.sol';
...
// Dependency file: @uniswap/v3-core/contracts/interfaces/IUniswapV3Factory.sol
...
// Dependency file: contracts/core/interfaces/IMulWork.sol
...
// Root file: contracts/core/UniswapV3Strategy.sol
...
// import "contracts/core/interfaces/IMulWork.sol";
// import "contracts/core/interfaces/IMulBank.sol";
...
contract UniswapV3Strategy is Ownable {
	...
	function divest(uint positionId) external onlyEOA returns(uint amount0, uint amount1){
        ...
        (amount0, amount1) = pool.burn(position.tickLower, position.tickUpper, pos.liquidity);
        
         = IUniswapV3Pool(pool).collect(address(this), pos.tickLower, pos.tickUpper, uint128(-1), uint128(-1));
        _close(positionId, amount0, amount1);

        emit Divest(msg.sender, positionId, amount0, amount1);
    }

    function collect(uint positionId) public re{
        Position storage pos = positions[positionId];
        require(msg.sender == pos.operator && !pos.close && pos.liquidity > 0, "FORBIDDEN");
        ...
        pool.collect(recipient, position.tickLower, position.tickUpper, fee0, fee1);

        distributeFee(pos.token0, fee0);
        distributeFee(pos.token0, fee1);

        pos.feeGrowthInside0LastX128 = feeGrowthInside0LastX128;
        pos.feeGrowthInside1LastX128 = feeGrowthInside1LastX128;
    }

    function distributeFee(address token, uint fee) internal {
